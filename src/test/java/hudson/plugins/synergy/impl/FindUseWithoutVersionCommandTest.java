...
public class FindUseWithoutVersionCommandTest {
  ...
  public void testParseResult() {
    ...
    FindUseWithoutVersionCommand command = new FindUseWithoutVersionCommand(Arrays.asList("InMemoryDataStore.java~2"), Collections.singleton("myproj~abcd"), "~");
  ...
  public void testParseResultMultiLine() {
    ...
    FindUseWithoutVersionCommand command = new FindUseWithoutVersionCommand(Arrays.asList("GdaErscheinungsform.dbx~16"), Collections.singleton("SE_Maven~u480vko_BT9.0.0"), "~");
