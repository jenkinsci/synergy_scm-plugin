...
/**
 * Kommando sucht nach Tasks, die fuer eine Menge an definierten Releases und
 * einem Zeitpunkt completed bzw. auch excluded wurden, da diese Menge
 * potentiell das Projekt ändern.
 *
 * @author u48jfe
 *
 */
public class FindCompletedSinceDateCommand extends Command {
    ...
    /**
     * ccm query -t task -u -f %objectname "(excluded_time &gt;=
     * time('2014/10/07 13:51:42') or completion_date &gt;= time('2014/10/07
     * 13:51:42')) and (release='BT9.0.0' or release='BT8.0_COPY' or
     * release='BT8.1_COPY' or release='BT8.2_COPY' or release='BT9.0_COPY')"
     * {@inheritDoc}
     */
    @Override
